...
_G._OSVERSION = "ZentOS 1.0.0"
-- _G.SYSTEMBACKGROUDCOLOR = 0x282B3D
-- _G.SYSTEMFOREGROUDCOLOR = 0x1EAB58
...
okeystatus("Loaded Package Management")
--status("Loaded Package Management")

-- Mount the ROM and temporary file systems to allow working on the file
-- system module from this point on.
require("filesystem").mount(computer.getBootAddress(), "/")

okeystatus("Loaded File System")
--status("Loaded File System")
...
okeystatus("Boot scripts is run")
--status("Boot scripts is run")

for c, t in component.list() do
  computer.pushSignal("component_added", c, t)
end

okeystatus("Loaded components")
--status("Loaded components")
