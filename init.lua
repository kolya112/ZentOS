_G._OSVERSION = "OpenLoader 0.2 | ZentOS Edition"
...
if gpu and screen then
    ...
    component.invoke(gpu, "setBackground", 0x282B3D)
    component.invoke(gpu, "setForeground", 0x1EAB58)
